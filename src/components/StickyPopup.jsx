  ...
  return (
    isVisible && (
      <>
        ...
        <div className="z-50 fixed bottom-0 left-0 w-full bg-white shadow-lg p-4 border-t border-gray-200 flex justify-between items-center">
          <p className="text-gray-800">This is a sticky popup!</p>
          <button
